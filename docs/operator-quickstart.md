# Operator Quickstart — Activities of other membership organizations n.e.c.

Shortest path from clone to a verified local dry-run for **ISIC 9499** (`cloud-itonami-isic-9499`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9499.git
cd cloud-itonami-isic-9499
```
...
- Blueprint governor key: `membership-governance-governor`
- Likely source path: `memberorg.governor.cljc`
