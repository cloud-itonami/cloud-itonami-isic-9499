...
`cloud-itonami-isic-9499` accepts contributions to the OSS blueprint, capability
...
- Keep publishing a public position on the organization's behalf behind the Membership Governance Governor.
